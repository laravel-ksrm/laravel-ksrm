...
class RegulationController extends Controller
{
    ...
    public function get_regulation_with_program($program_level)
    {
        return Regulation::with(['program', 'semesters', 'program.specializations'])->where('program_id',$program_level)->get();
    }
    ...
    public function get_specializations($regulation_id)
    {
        if (is_numeric($regulation_id)) {
            ...
            return Regulation::with(['semesters'])->where('short_name', $regulation_id)->firstOrFail()->program->specializations;
        }
    }
